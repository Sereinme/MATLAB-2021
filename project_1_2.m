...
imwrite(hall_color, 'images/hall_color.jpg');
subplot(2, 2, 1);
imshow(hall_color);
title("Original Image", 'FontSize', 14);

imwrite(hall_gray, 'images/hall_gray.jpg');
subplot(2, 2, 2);
imshow(hall_gray);
...
B(circle_area) = 0;
hall_circle(:, :, 3) = B;
imwrite(hall_circle, 'images/hall_circle.jpg');
subplot(2, 2, 3);
imshow(hall_circle);
...
B(chess_area) = 0;
hall_chess(:, :, 3) = B;
imwrite(hall_chess, 'images/hall_chess.jpg');
subplot(2, 2, 4);
imshow(hall_chess);
